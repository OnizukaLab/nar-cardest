...
class EmbModule(nn.ModuleList):
    def __init__(
        ...
        self.use_smaller_emb = use_smaller_emb
...
class NAR(pl.LightningModule):
    def __init__(
        ...
        self.embs = EmbModule(self.input_bins, self.d_word, self.cont_fanout)
    ...
    def _step(self, batch) -> torch.Tensor:
        x = batch.to(self.device).to(torch.float32)
